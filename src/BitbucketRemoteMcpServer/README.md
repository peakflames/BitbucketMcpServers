...
### Examples
- `https://your-mcp-server-url/example-repo/sse` → Uses the first repository configuration
- `https://your-mcp-server-url/example-repo-2/sse` → Uses the second repository configuration
