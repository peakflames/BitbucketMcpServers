#!/usr/bin/env python3
"""
Build script for BitbucketMcpServers
...
SOLUTION_PATH = "BitbucketMcpServers.sln"
PROJECT_PATH = "src/BitbucketRemoteMcpServer/BitbucketRemoteMcpServer.csproj"
PID_FILE = Path(".bitbucket-mcp.pid")
LOG_FILE = Path("bitbucket-mcp.log")
DEV_PORT = 5107
...
def print_usage() -> None:
    ...
    print('  python build.py mcp call list_pull_open_requests \'{"repoName": "my-repo"}\'')
    print('  python build.py mcp call get_pull_request_details \'{"repoName": "my-repo", "pullRequestId": "123"}\'')
